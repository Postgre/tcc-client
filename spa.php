            ...
            <div class="col_half fright col_last nobottommargin">
                <div class="top-links">
                    <ul>
                        ...
                        <li class="tcc_if_admin"><a href="#!promos">Promos</a></li>
                        <li class="tcc_if_admin"><a href="#!resellers">Resellers</a></li>
                        <li class="tcc_if_admin"><a href="#!caroler-list">Carolers</a></li>
                        <li class="tcc_if_admin"><a href="#!customer-events">Events</a></li>
                    </ul>
                </div>
            </div>
        </div>
